...
test.initialize('08-paths', function () {
  ...
  it('the listener should pick up a single wildcard event', function (callback) {
    ...
    try {
      ...
      listenerclient.on('/08_paths/' + test_id + '/testsubscribe/data/event/*', {
        event_type: 'set',
        count: 1
      }, function (message) {

        expect(listenerclient.events['/SET@/08_paths/' + test_id + '/testsubscribe/data/event/*'].length).to.be(0);
        callback();
        ...
        if (!e) {
          ...
          expect(listenerclient.events['/SET@/08_paths/' + test_id + '/testsubscribe/data/event/*'].length).to.be(1);

          var stats = happnInstance.stats();

          //then make the change
          publisherclient.set('/08_paths/' + test_id + '/testsubscribe/data/event/blah', {
            property1: 'property1',
            property2: 'property2',
            property3: 'property3'
  ...
  it('set_multiple, the publisher should set multiple data items, then do a wildcard get to return them', function (callback) {
    ...
    var testBasePath = '/08_paths/' + test_id + '/set_multiple'
          ...
          listenerclient.get(testBasePath + '/' + '*', null, function (e, results) {
            ...
            results.every(function (result) {
              ...
              /*
               ...
               path: '/08_paths/1443606046555_VkyH6cE1l/set_multiple/E17kSpqE1l' } }
               */
  ...
  it('should set data, and then merge a new document into the data without overwriting old fields', function (callback) {
    ...
    try {
      ...
      publisherclient.set('/08_paths/' + test_id + '/testsubscribe/data/merge/' + test_path_end, {
        property1: 'property1',
        property2: 'property2',
        property3: 'property3'
      }, null, function (e, result) {
        ...
        publisherclient.set('/08_paths/' + test_id + '/testsubscribe/data/merge/' + test_path_end, {property4: 'property4'}, {merge: true}, function (e, result) {
          ...
          publisherclient.get('/08_paths/' + test_id + '/testsubscribe/data/merge/' + test_path_end, null, function (e, results) {
  ...
  it('should search for a complex object', function (callback) {
    ...
    publisherclient.set('/08_paths/' + test_id + '/testsubscribe/data/complex/' + test_path_end, complex_obj, null, function (e, put_result) {

      expect(e == null).to.be(true);
      publisherclient.set('/08_paths/' + test_id + '/testsubscribe/data/complex/' + test_path_end + '/1', complex_obj, null, function (e, put_result) {
        expect(e == null).to.be(true);

        ////////////console.log('searching');
        publisherclient.get('/08_paths/' + test_id + '/testsubscribe/data/complex*', {
          criteria: criteria1,
          options: options1
  ...
  it('should delete some test data', function (callback) {
    ...
    try {
      ...
      publisherclient.set('/08_paths/' + test_id + '/testsubscribe/data/delete_me', {
        property1: 'property1',
        property2: 'property2',
        property3: 'property3'
      }, {noPublish: true}, function (e, result) {
        ...
        publisherclient.remove('/08_paths/' + test_id + '/testsubscribe/data/delete_me', {noPublish: true}, function (e, result) {
  ...
  it('should tag some test data', function (callback) {
    ...
    publisherclient.set('/08_paths/' + test_id + '/test/tag', {
      property1: 'property1',
      property2: 'property2',
      property3: 'property3'
    }, {noPublish: true}, function (e, result) {
      ...
      publisherclient.set('/08_paths/' + test_id + '/test/tag', null, {
        tag: randomTag,
        merge: true,
        noPublish: true
      }, function (e, result) {
        ...
        publisherclient.get('/_TAGS/08_paths/' + test_id + '/test/tag/*', null, function (e, results) {
    ...
    try {
      ...
      listenerclient.on('/08_paths/' + test_id + '/testsubscribe/data/event', {
        ...
        if (!e) {
          ...
          //then make the change
          publisherclient.set('/08_paths/' + test_id + '/testsubscribe/data/event', {
            property1: 'property1',
            property2: 'property2',
            property3: 'property3'
          }, null, function (e, result) {
...
//  We set the listener client to listen for a PUT event according to a path, then we set a value with the publisher client.
  ...
  it('the listener should pick up a single delete event', function (callback) {
    ...
    publisherclient.set('/08_paths/' + test_id + '/testsubscribe/data/delete_me', {
      ...
      listenerclient.on('/08_paths/' + test_id + '/testsubscribe/data/delete_me', {
        event_type: 'remove',
        count: 1
      }, function (eventData) {
        ...
        ////console.log(listenerclient.events);
        expect(listenerclient.events['/REMOVE@/08_paths/' + test_id + '/testsubscribe/data/delete_me'].length).to.be(0);
        ...
        ////console.log(listenerclient.events);
        expect(listenerclient.events['/REMOVE@/08_paths/' + test_id + '/testsubscribe/data/delete_me'].length).to.be(1);

        //////////////////console.log('subscribed, about to delete');

        //We perform the actual delete
        publisherclient.remove('/08_paths/' + test_id + '/testsubscribe/data/delete_me', null, function (e, result) {
  ...
  it('should unsubscribe from an event', function (callback) {
    ...
    listenerclient.on('/08_paths/' + test_id + '/testsubscribe/data/on_off_test', {
      event_type: 'set',
      count: 0
    }, function (message) {
      ...
      listenerclient.offPath('/08_paths/' + test_id + '/testsubscribe/data/on_off_test', function (e) {
        ...
        listenerclient.on('/08_paths/' + test_id + '/testsubscribe/data/on_off_test', {
          ...
          function (e, listenerId) {
            ...
            publisherclient.set('/08_paths/' + test_id + '/testsubscribe/data/on_off_test', {
              property1: 'property1',
              property2: 'property2',
              property3: 'property3'
  ...
  it('should subscribe to the catch all notification', function (callback) {
    ...
    listenerclient.onAll(function (eventData, meta) {
      ...
      if (meta.action == '/REMOVE@/08_paths/' + test_id + '/testsubscribe/data/catch_all' ||
        meta.action == '/SET@/08_paths/' + test_id + '/testsubscribe/data/catch_all')
        caughtCount++;
      ...
      publisherclient.set('/08_paths/' + test_id + '/testsubscribe/data/catch_all', {
        property1: 'property1',
        property2: 'property2',
        property3: 'property3'
      }, null, function (e, put_result) {

        publisherclient.remove('/08_paths/' + test_id + '/testsubscribe/data/catch_all', null, function (e, del_result) {
  ...
  it('should unsubscribe from all events', function (callback) {
    ...
    listenerclient.onAll(function (message) {
      ...
      listenerclient.on('/08_paths/' + test_id + '/testsubscribe/data/off_all_test', {
          event_type: 'set',
          count: 0
        },
        function (message) {
        ...
        function (e) {
          ...
          listenerclient.offAll(function (e) {
            ...
            publisherclient.set('/08_paths/' + test_id + '/testsubscribe/data/off_all_test', {
              property1: 'property1',
              property2: 'property2',
              property3: 'property3'
            }, null, function (e, put_result) {
